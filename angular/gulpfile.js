...
gulp.task('build', function(done) {
    runSequence('translations', 'build:clean', 'build:sass', 'build:pug', 'build:translate', 'build:translate:fix', 'build:material:fix', 'build:img', 'build:js', 'build:lib', 'build:browserify', 'build:templates', 'build:css', 'build:index', done);
});
